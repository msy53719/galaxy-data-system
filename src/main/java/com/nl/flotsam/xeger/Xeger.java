...
public class Xeger {
	 ...
	 * @param random
	 *            The object that will randomize the way the String is generated.
	 *            (Not <code>null</code>.)
	...
	/**
	 * As {@link nl.flotsam.xeger.Xeger#Xeger(String, java.util.Random)}, creating a
